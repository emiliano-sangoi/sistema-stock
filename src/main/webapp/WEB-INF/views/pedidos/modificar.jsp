...
<p class="lead">A continuación, realice las modificaciones necesarias y guarde los cambios.</p>


<form:form method="POST" action="/tp_final/pedidos/modificar" 
...
<!-- 			<div class="col-xs-12 col-sm-3">Fecha de creacion:		 -->
<%-- 				<form:input path="date" type="hidden" value="${order.codOp}" id="input-op" name="input-op" /> --%>
<!-- 			</div> -->
<!-- 			<div class="col-xs-12 col-sm-3">Estado: 		</div> -->
